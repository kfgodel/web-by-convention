...
/**
 * Modified from original to prevent windows locking files.
 ...
 */
public class NonLockingResourceHandler extends ResourceHandler
{
    private static final Logger LOG = Log.getLogger(org.eclipse.jetty.server.handler.ResourceHandler.class);
    ...
    /* ------------------------------------------------------------ */
    public NonLockingResourceHandler()
    {
    ...
    public void handle(String target, Request baseRequest, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException
    {
        ...
        else
        {
                ...
                resource.length()>=min_async_size)
            {
                ...
                {
                    // Using old buffer to prevent Windows file lock
